...
export const aiEnabledTeamsContent: AIEnabledTeamsContent = {
  safeAndEmpowered: {
    intro:
      "We saw AI's potential early, but we knew trust had to come first. Before rolling anything out to clients, we tested it where it mattered most—across code, quality, and high-impact processes—tracking gains, mitigating risks, and shaping a system around what actually delivers. What began as hands-on experimentation is now a company-wide framework designed to embed AI-driven efficiency without ever risking control, transparency, security, or delivery pace.",
    bullets: [
      ...
      "Team-wide training, structured knowledge-sharing, and an internal AI challenge that keeps our talent sharp",
    ],
    closing:
  ...
  everythingYouNeedToKnow: {
    ...
    researchBullets: [
      {
        cite: "Accenture",
        text: "74% of organizations state their generative AI and automation investments meet or exceed expectations, with AI-led processes driving 2.5x higher revenue growth and 2.4x greater productivity than peers.",
      },
      {
        cite: "DORA research",
        text: "Increasing an individual's AI adoption by 25% correlates with a 2.1% increase in productivity and a 2.2% increase in job satisfaction.",
      },
      {
        cite: "McKinsey",
  ...
  whatMakesSpecial: [
    ...
    },
    {
      title: "Security",
      description:
        "Security remains paramount in every implementation. Only pre-screened tools classified as low risk are introduced, with continuous monitoring in place to catch changes early. Every layer is supported by our security management practices, so you benefit from AI efficiency with the assurance that compliance and protection are never compromised.",
    },
  ],
  ctaBlocks: [
    {
  ...
  sdlcPhases: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Validation rules and edge case scenarios are generated automatically.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "CI/CD pipeline performance is constantly monitored to identify bottlenecks, with straightforward suggestions to speed up builds and deployments.",
        "Repetitive approvals and rollbacks stop wasting time, thanks to automated workflows.",
        "Teams get concise log summaries that dramatically reduce triage time.",
        "Monitoring is less noisy: anomalies surface, irrelevant alerts stay quiet.",
        "Root cause analysis connects the dots across logs, traces, and metrics.",
        "Configuration templates and scripts are generated upfront to ensure consistency and reproducibility.",
      ],
    },
    {
      number: "06",
    ...
    },
    {
      ...
      title: "Analytics",
      bullets: [
        "Teams can describe their intent in plain language and receive ready-to-run queries.",
        "Repetitive steps like data cleaning, transformation, or formatting are automated.",
        "Teams get visualizations and recommendations tailored to the data.",
        "Dashboards stay updated without manual intervention; data is refreshed, anomalies highlighted, and key metrics surfaced automatically.",
      ],
    },
  ],
  outcomes: [
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "We recommend using only tools that do not use your data for model training, and whose vendors clearly confirm that you retain ownership and control of all outputs. We work strictly within your internally approved toolset and never introduce new tools without your consent. Our team follows recognized best practices in how AI is configured and used.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Our engineers continuously steer AI to keep delivery on track. If a tool underperforms, you'll know right away, and we'll suggest corrective actions or replace it with another vetted option. Accountability stays with us.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No. Our delivery model is human-first: AI is an accelerator, not a decision-maker. Experienced engineers remain fully responsible for architecture, design choices, and code quality.",
    },
  ],
  stats: [
    { value: "20+", label: "Years of proven delivery expertise" },
    { value: "15%", label: "Typical productivity uplift with AI-enabled teams" },
    { value: "Human-first", label: "AI augments engineers without replacing them" },
    { value: "Pre-vetted", label: "Only approved, low-risk tools introduced" },
  ],
};
